...
#
#   Date: 3 April 2020
#   Date: 27 May 2020. Add current year climate model for Model 5BN and Model 4ABCN
#
#########################################################################
#
...
####################  Model 4ABCN - Two Year Climate - Local differentiation in all 3 parameters  (a, b, and c)
...
####################  Model 4ABCN - Current Climate - Local differentiation in all 3 parameters  (a, b, and c)

model_4ABCN_1yr <- function(PG,siteplot,region,sizeX0,sizeXb,ageX0,alpha,beta,C,gamma,D,lambda,
						    n.b,n.c,
...
model_5BN_1yr <- function(PG,siteplot,sizeX0,sizeXb,ageX0,alpha,beta,C,gamma,D,lambda,
                                          n.b,n.c,
                                          temp.a.prime, temp.b.prime,temp.c.prime,
                                          temp.b, temp.c,
                                          prec.a.prime, prec.b.prime,prec.c.prime,
...
model_5BN_1yr_ppt <- function(PG,siteplot,sizeX0,sizeXb,ageX0,alpha,beta,C,gamma,D,lambda,
                                          n.b,n.c,
                                          temp.a.prime, temp.b.prime,temp.c.prime,
                                          temp.lag.a.prime, temp.lag.b.prime, temp.lag.c.prime,
                                          temp.b, temp.c, temp.lag.b, temp.lag.c,
                                          ...
                                          prec.b, prec.c)
{
   ...
   PG[siteplot] * size.effect * age.effect * competition.effect *  nitr.effect *
       (temp.effect + temp.lag1.effect) * prec.effect
}
